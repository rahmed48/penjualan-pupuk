                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-element-list">
                                        ...
                                        <form action="tambah_data_pupuk_act.php" method="POST">
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <div class="form-group">
                                                        <div class="nk-int-st">
                                                            <label class="control-label">Nama Produk</label>
                                                            <input class="form-control" type="text" name="jenis_pupuk" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <div class="form-group">
                                                        <div class="nk-int-st">
                                                            ...
                                                            <input class="form-control" type="number" name="harga_pupuk" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <div class="form-group">
                                                        <div class="nk-int-st">
                                                            ...
                                                            <input class="form-control" type="text" name="rumus_kimia" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
