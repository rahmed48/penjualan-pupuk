                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-element-list">
                                        ...
                                        <form action="edit_data_distributor_act.php" method="POST" enctype="multipart/form-data">
                                            <input  type="hidden" name="id" class="form-control" value="<?php echo $data['id_distributor']; ?>">                                                    
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <div class="form-group">
                                                        <div class="nk-int-st">
                                                            <label class="nk-label">Nama Distributor</label>
                                                            <input type="text" name="nama_distributor" class="form-control" value="<?php echo $data['nama_distributor']; ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <div class="form-group">
                                                        <div class="nk-int-st">
                                                            ...
                                                            <input type="text" name="email_distributor" class="form-control" value="<?php echo $data['email_distributor']; ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <div class="form-group">
                                                        <div class="nk-int-st">
                                                            ...
                                                            <input type="text" name="alamat_distributor" class="form-control" value="<?php echo $data['alamat_distributor']; ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
