...
// Load file mainmenu.php 
        ...
        <div class="normal-table-area">
            <div class="container">
                ...
                include 'koneksi.php';
                $id = $_GET ['id'];
                $sql = "SELECT * FROM pupuk WHERE id_pupuk='$id'";
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-element-list">
                                        ...
                                        <form action="edit_data_pupuk_act.php" method="POST" enctype="multipart/form-data">
                                            <input  type="hidden" name="id" class="form-control" value="<?php echo $data['id_pupuk']; ?>">
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <div class="form-group">
                                                        <div class="nk-int-st">
                                                            <label class="control-label">Nama Produk</label>
                                                            <input class="form-control" type="text" name="jenis_pupuk" value="<?php echo $data['jenis_pupuk']; ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <div class="form-group">
                                                        <div class="nk-int-st">
                                                            ...
                                                            <input class="form-control" type="text" name="harga_pupuk" value="<?php echo $data['harga_pupuk']; ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <div class="form-group">
                                                        <div class="nk-int-st">
                                                            <label class="control-label">Rumus Kimia </label>
                                                            <input class="form-control" type="text" name="rumus_kimia" value="<?php echo $data['rumus_kimia']; ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
