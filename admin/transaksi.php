                                        ...
                                        <tbody>
                                            ...
                                            while ($data = mysqli_fetch_array($query)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="row">
                                                            <a href="detail_transaksi.php?id=<?php echo $data['id_transaksi']; ?>"class="btn btn-info notika-btn-teal">Detail</a>
                                                            <a href="cetak_detail_transaksi.php?id=<?php echo $data['id_transaksi']; ?>"class="btn btn-info notika-btn-teal" target="_BLANK">Cetak</a>
                                                        </div>
                                                    </td>                                                    
                                                </tr>
                                            <?php } ?>
