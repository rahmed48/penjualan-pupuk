...
// Load file mainmenu.php 
        ...
        <div class="normal-table-area">
            <div class="container">
                ...
                include 'koneksi.php';
                $id = $_GET ['id'];
                $sql = "SELECT * FROM gudang_to_pupuk WHERE id_gudang_to_pupuk='$id'";
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-element-list">
                                        <div class="basic-tb-hd">
                                            <h2>Edit Data Ketersediaan</h2>
                                        </div>
                                        <form action="edit_gudang_to_pupuk_act.php" method="POST">
                                            <input  type="hidden" name="id" class="form-control" value="<?php echo $data['id_gudang_to_pupuk']; ?>">
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">                                                    
                                                    <div class="chosen-select-act fm-cmp-mg">
                                                        ...
                                                        $sql2 = "SELECT * FROM gudang";
                                                        $query2 = mysqli_query($koneksi, $sql2);
                                                        ?>
                                                        <select name="id_gudang" id="id_gudang" class="chosen" data-placeholder="Pilih Gudang"> 
                                                            <?php $selected = ""; ?>

                                                            <?php while ($row = mysqli_fetch_array($query2)) { ?>
                                                                <?php if ($row['id_gudang'] == $data['id_gudang']) { ?>
                                                                ...
                                                                ?>
                                                                <option value="<?php echo $row['id_gudang']; ?>" <?php echo $selected; ?>>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">                                                    
                                                    <div class="chosen-select-act fm-cmp-mg">
                                                        ...
                                                        $sql3 = "SELECT * FROM pupuk";
                                                        $query3 = mysqli_query($koneksi, $sql3);
                                                        ?>
                                                        <select name="id_pupuk" id="id_pupuk" class="chosen" data-placeholder="Pilih Pupuk"> 
                                                            <?php $selected = ""; ?>

                                                            <?php while ($row = mysqli_fetch_array($query3)) { ?>
                                                                <?php if ($row['id_pupuk'] == $data['id_pupuk']) { ?>
                                                                    <?php $selected = 'selected'; ?>
                                                                ...
                                                                ?>
                                                                <option value="<?php echo $row['id_pupuk']; ?>" <?php echo $selected ?>>
                                                                    <?php echo $row['jenis_pupuk']; ?>
                                                                </option>
                                                            <?php } ?>
                                                        </select>
                                                    </div>
